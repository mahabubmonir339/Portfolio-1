            ...
            <div className="hero min-h-screen text-white m-10">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className='ml-12'>
                        ...
                        <Link to='/contract' className='grid justify-items-end m-4'><button class="btn btn-outline text-white rounded-full border-2 border-Y">Contract Me <i class="fa-solid fa-arrow-up-right-from-square ml-4"></i></button>
                        </Link>
                    </div>
                </div>
            </div>
            <div class="btn-group grid grid-cols-1">
                <Link to='/about' className='grid justify-items-center m-4'><button class="btn btn-outline text-white"> ABOUT <i class="fa-solid fa-arrow-right text-Y ml-4"></i></button></Link>
            </div>
        </div>
    );
};
