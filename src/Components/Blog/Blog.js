    ...
    return (
        <div className='container mx-auto bg-[#0f172a] h-full p-10'><br /><br />
            ...
            <section className='grid grid-cols-3 gap-4 place-items-center h-full m-10'>
                <div class="card card-compact w-68 h-96 bg-[#475569] shadow-xl">
                ...
                <div class="card card-compact w-68  h-96 bg-[#475569] shadow-xl">
                    <figure><img src="https://img.freepik.com/premium-photo/hand-touching-network-connecting-human-dots-icon-business-project-management_34200-326.jpg?w=1480" alt="Shoes" /></figure>
                    <div class="card-body">
            ...
            <div class="btn-group grid grid-cols-2">
                <Link to='/contract' className='grid justify-items-end m-4'><button class="btn btn-outline text-white"><i class="fa-solid fa-arrow-left text-Y mr-4"></i> Contract </button></Link>

                <Link to='/' className='grid justify-items-start m-4'><button class="btn btn-outline text-white">Home <i class="fa-solid fa-arrow-right text-Y ml-4"></i></button></Link>
            </div>
